...
// Only glob image files in public/. The OG image (site.ogImage) is always an
// image, and globbing extensionless files (e.g. public/_redirects) would make
// Vite attempt to parse them as JS modules and break the build.
const publicFiles = import.meta.glob("/public/*.{png,jpg,jpeg,gif,webp,avif,svg}", {
  eager: false,
});
