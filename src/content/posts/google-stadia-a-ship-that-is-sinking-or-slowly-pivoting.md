---
title: "Google Stadia - A Ship That Is Sinking Or Slowly Pivoting?"
author: Ajith Thilakan
pubDatetime: 2021-07-26T01:34:39Z
description: "Google Stadia has faced some big setbacks over the last year, closing its internal game studios and suffering poor engagement. I reflect on some key takeaways from this experience, the challenges in building a AAA studio and building up the flywheel for a game streaming platform."
...
However, these big investments would take longer to have an impact on their performance - which while there are no public figures on, it's apparent they were already [missing the mark considerably](https://arstechnica.com/gaming/2021/02/report-stadia-undershot-to-the-tune-of-hundreds-of-thousands-of-users/). Initial reviews were [mixed](https://www.engadget.com/google-stadia-173003693.html) - it seemingly offering casual gamers a value entry point, but with inconsistent but improving performance, and a limited game selection. Earlier this year, they announced that Google would be [closing their game development studios](https://kotaku.com/google-stadia-shuts-down-internal-studios-changing-bus-1846146761). And there have been other negative developments that now have the industry wondering, is [Google Stadia a sinking ship?](https://kotaku.com/google-says-everything-at-stadia-is-fine-as-the-water-1846896205)
...
![](/assets/2021/07/image.png)
*I couldn't help it - the meme potential of the Suez Canal Evergreen incident was too compelling not to use as a visual example*

#### The Challenges of Building a AAA Game Studio

AAA games are [expensive to make](https://kotaku.com/how-much-does-it-cost-to-make-a-big-video-game-1501413649), upwards of $50 million in development costs for many popular titles, with some going way beyond e.g. [Grand Theft Auto V cost $137 million on development alone!](https://en.wikipedia.org/wiki/List_of_most_expensive_video_games_to_develop)
...
It can take some studios [2 - 3 years to launch a AAA title](https://geekygamingstuff.com/what-are-aaa-games/#How_long_does_it_take_to_finish_an_AAA_game). You can see this when you look at the history of some popular studios. [Naughty Dog](https://en.wikipedia.org/wiki/List_of_Naughty_Dog_video_games) took anywhere from 1-3 years between their games launched in the last 10 years, and they only published the Uncharted and Last of Us series. Some studios can be more prolific when they land on a good formula that they can replicate within their development pipeline. Ubisoft had been [pumping out Assassin Creed installments](https://en.wikipedia.org/wiki/Assassin%27s_Creed) almost every year at their peak, and the same for Activision and their [Call of Duty series](https://en.wikipedia.org/wiki/Call_of_Duty).

But all of those studios had already been developing games before these prominent titles. To start a studio from scratch and get to that launch cadence could take a long time (years I would bet), which I doubt Google would have the stomach for. They did [acquire Typhoon studios](https://www.gamesindustry.biz/articles/2019-12-19-stadia-acquires-typhoon-studios), but they only had one game ready for launch at the time, which is a risky play. In contrast, from [the first Xbox launch](https://www.bloomberg.com/news/features/2021-01-06/xbox-the-oral-history-of-an-american-video-game-empire), Microsoft has been on a [buying spree to build up their game portfolio](https://www.pcgamer.com/every-game-and-studio-microsoft-now-owns/).
...
>
> — [kotaku.com](https://kotaku.com/stadia-leadership-praised-development-studios-for-great-1846281384)

#### Building The Platform Flywheel

With Google's investments in cloud infrastructure, they were cognizant of the possibilities that were available with rapidly improving connection speeds/latencies, off-premise compute, and storage capabilities. They tested some proof of concepts in 2016 and opened to [beta in 2018](https://www.theverge.com/2018/10/8/17950998/google-project-stream-gaming-assasins-creed-odyssey-first-impression). I should highlight that they were not the only ones to realize this, the other big players with significant cloud infrastructure also were beginning to see this. Amazon launched their streaming service, [Luna in September 2020](https://www.theverge.com/2020/9/24/21451371/amazon-luna-cloud-gaming-service-twitch-alexa-controller), and Microsoft launched their [xCloud service around the same time](https://www.videogameschronicle.com/news/xcloud-launching-in-september-and-included-with-xbox-game-pass-ultimate/).
