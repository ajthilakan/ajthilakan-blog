---
title: "Blogging 3.0 - New Monetization Models and Greater Opportunities For Independent Writing"
author: Ajith Thilakan
pubDatetime: 2021-08-16T00:35:41Z
description: "Blogging and digital journalism is changing. I touch on the growing platforms underpinning a broader disruption of the ad-based attention economy - opening up newer monetization models that enable greater value capture and independence for writers."
...
Sure, you could monetize by including ads in your blog, along with [some other methods](https://www.forbes.com/sites/johnrampton/2017/11/09/25-ways-to-make-money-from-your-blog/?sh=78fbc6ea4892), but it wasn't easy to build a living as a writer based solely on your voice unless you joined a publication with a larger brand presence that you aligned with. Individual writers were usually either part of a larger editorial voice or stuck within their small niche.
...
Medium is a "social journalism" platform, [launched in 2012](https://en.wikipedia.org/wiki/Medium_(website)) by Twitter co-founder Evan Williams, initially aiming to make it as easy as possible to write and publish a story without having to set up your own blog.

In their early years, they focused heavily on optimizing for time [spent reading on-site](https://medium.com/data-lab/mediums-metric-that-matters-total-time-reading-86c4970837d5), as opposed to unique visitors and their audience size. This resulted in a platform that had a user experience well optimized for article discovery and reading.

They saw [significant growth](https://500ish.com/long-medium-b9ddfe2c3a0a) over the next few years - in 2016, they had 7.5 million posts published and 60 million readers using the platform. With such a large reader base, Medium offered bloggers huge reach by syndicating their stories, making it a very compelling platform for anyone looking to publish, as [Sam Mallikarjunan](https://medium.com/@Mallikarjunan) summarized in this [great article](https://thinkgrowth.org/why-medium-works-16e9ef818f66#.u1au6lhul):
...
>
> — [Sam Mallikarjunan](https://medium.com/@Mallikarjunan) - [Why Medium Works](https://thinkgrowth.org/why-medium-works-16e9ef818f66#.u1au6lhul)
...
>
> — [Ev Williams - Upgrade Your Medium](https://blog.medium.com/upgrade-your-medium-924b74c36552)

While they lost some larger [publications](https://www.adweek.com/performance-marketing/like-the-ringer-before-it-backchannel-is-leaving-medium/) as a result of this (some still preferred to rely on ad-based revenue), this strategy seemed to work. By 2019, Medium had about [400,000 paid subscribers](https://www.axios.com/medium-subscribers-buyout-ev-williams-88549883-dd36-4bb6-88cf-089cf174648d.html) and the number was continuing to grow (eventually hitting 725,000 subscribers in 2021).

While they were getting validation that this monetization model could work, Medium was still trying to figure out its content strategy. Going back to the example of Netflix, they knew they could use readership insights to develop their own publications. And in 2018, they started [investing in their editorial team](https://www.axios.com/medium-subscribers-buyout-ev-williams-88549883-dd36-4bb6-88cf-089cf174648d.html), hiring experienced writers and editors to launch high-end digital publications. They doubled down on this in 2019, but the economics for that didn't quite work. And earlier this year, Medium [announced](https://ev.medium.com/medium-editorial-team-update-8679bcb9fe81) that they would be shifting their focus to supporting independent writers and cutting in-house editorial operations. We could dig into why their editorial strategy didn't work, [one take](https://digiday.com/media/four-years-into-a-subscription-strategy-medium-still-doesnt-spend-money-to-acquire-subscribers/) was that they relied too much on organic discovery and did not like to pay for search advertising, which could have improved their top-funnel for these larger investments. Perhaps developing a long tail of independent writers, could drive better organic discovery?

As they were still figuring this out, another strategic shift was working well for them - they were shifting towards a more [relational media strategy](https://ev.medium.com/toward-a-more-relational-medium-e801ff4653a4). They were shifting their experience from enabling a more transactional type of media consumption towards a relational style. As an example, their home experience was more focused on the writers you followed, and less on their discovery algorithm and the biggest headlines. These types of changes would enable writers to build trust and grow relationships with their readers.
...
>
> — [Ev Williams - Towards a more relational Medium](https://ev.medium.com/toward-a-more-relational-medium-e801ff4653a4)
...
However there would soon be successful examples of this, the most prominent use case was not from a tech company but an independent writer. [Ben Thompson](https://stratechery.com/about/) started the tech blog Stratechery in 2013, and by moving his posts [behind a paywall around 2014](https://medium.com/hyperlinked/ben-thompsons-stratechery-should-be-crossing-3-million-in-profits-this-year-c146433f0458) through a freemium subscription model, he was able to support this as a full-time job (and a well-paying one!).
...
>
> — [Ben Thompson's Stratechery should have crossed $3 Million in Profits in 2020 - Andreas Stegmann](https://medium.com/hyperlinked/ben-thompsons-stratechery-should-be-crossing-3-million-in-profits-this-year-c146433f0458)

[Some claim](https://www.vox.com/2017/10/16/16480782/substack-subscription-newsletter-sinocism-bill-bishop-ben-thompson-stratechery) he pioneered this paid newsletter business model and was the inspiration behind Substack - a newsletter subscription platform. Substack was [founded in 2017](https://en.wikipedia.org/wiki/Substack), allowing writers to easily start their own newsletter and monetize it using their tools.
...
>
> — [Ben Thompson on Substack - Vox](https://www.vox.com/2017/10/16/16480782/substack-subscription-newsletter-sinocism-bill-bishop-ben-thompson-stratechery)

By 2021, Substack had more than [500,000 paying subscribers](https://backlinko.com/substack-users), with top writers on the platform earning over [$15 million / year](https://on.substack.com/p/investing-in-writers) through their publication subscriptions. The growth of this platform and the new revenue model for writers was not going unnoticed, with Twitter acquiring Substack competitor [Revue in 2021](https://blog.twitter.com/en_us/topics/company/2021/making-twitter-a-better-home-for-writers). Revue is a similar newsletter platform [founded in 2015](https://www.crunchbase.com/organization/revue), that launched its [subscriptions feature in 2018](https://www.getrevue.co/profile/the_week_in_newsletters/issues/how-much-to-charge-for-paid-newsletter-299536).
...
>
> — [Investing in Writers - Substack](https://on.substack.com/p/investing-in-writers)
...
> [Twitter thread by Chris Dixon (@cdixon)](https://twitter.com/cdixon/status/1425645842552086532?s=20)

In a great Twitter [thread](https://twitter.com/cdixon/status/1425645842552086532?s=20), Chris Dixon described the opportunity for web 3.0 startups to eat into the margins of web 2.0 incumbents, and was especially prevalent in the social media platforms that had 100% take-up rates, not sharing any revenue with content creators.

While the definition of web 3.0 is broad, and these players may not strictly fit that definition - the opportunity here is similar. **These new monetization models are opening up opportunities for platforms to eat into each other's margins by returning more value to the content creators.** You can already see this when you compare Substack and Revue's similar [products and their pricing](https://www.newslettercrew.com/blog/substack-vs-revue) - excluding payment processing fees, Substack is charging 10% of subscription revenue, while Revues charging 5%
...
>
> — [Substack on the Letter Acquisition](https://on.substack.com/p/sit-right-down-and-write-yourself-a-letter)
...
- 2.0 - There was a shift as blogging could support business needs and allowed some value capture for brands through lead generation, as well as the [bloggers (turned influencers or advertisers](https://www.huffpost.com/entry/blogging-marketing-business_b_1577139)).
...
*[Source: xkcd](https://xkcd.com/741)*
